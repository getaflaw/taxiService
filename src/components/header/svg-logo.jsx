...
export const Logo = ({width,height}) => {
	return (<svg width={width} height={height} viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M10.0534 10.1303L13.8274 13.9044" stroke="#FDBF5A" strokeWidth="4"/>
			<path d="M18.127 48.8897L14.3529 52.6637" stroke="#FDBF5A" strokeWidth="4"/>
			<path d="M24.8549 41.7132L21.0809 45.4872" stroke="#FDBF5A" strokeWidth="4"/>
			<path d="M31.5828 34.5368L27.8088 38.3108" stroke="#FDBF5A" strokeWidth="4"/>
			<path d="M45.0387 20.1838L41.2647 23.9578" stroke="#FDBF5A" strokeWidth="4"/>
			<path d="M51.7667 13.0074L47.9926 16.7814" stroke="#FDBF5A" strokeWidth="4"/>
			...
			<path d="M38.3108 27.3603L34.5368 31.1343" stroke="#FDBF5A" strokeWidth="4"/>
		</svg>
	)
}